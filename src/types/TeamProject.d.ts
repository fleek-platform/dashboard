import { InvitationsQuery, PermissionGroupsQuery, ProjectMembersQuery } from '@/generated/graphqlClient';
...
export type PermissionGroup = PermissionGroupsQuery['permissionGroups']['data'][0];
