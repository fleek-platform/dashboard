...
describe('joinBase with assets directory', () => {
  ...
  it('should handle image paths with query parameters', () => {
    ...
    expect(joinBase('assets/images/profile.png?v=2')).toBe(
      '/dashboard/assets/images/profile.png?v=2',
    );
  });
  ...
  it('should work with nested image directories', () => {
    ...
    expect(joinBase('assets/images/users/avatars/default.png')).toBe(
      '/dashboard/assets/images/users/avatars/default.png',
    );
  });
  ...
  it('should handle different image formats correctly', () => {
    ...
    expect(joinBase('/assets/images/icon.svg')).toBe(
      '/dashboard/assets/images/icon.svg',
    );
    expect(joinBase('/assets/images/banner.webp')).toBe(
      '/dashboard/assets/images/banner.webp',
    );
  });
