...
const Root = forwardStyledRef<HTMLDivElement, Scrollable.RootProps>(
  S.Root,
  ({ children, ...props }, ref) => (
...
const HorizontalBar = forwardStyledRef<HTMLDivElement, Scrollable.BarProps>(
  S.Scrollbar,
  (props, ref) => (
...
const VerticalBar = forwardStyledRef<HTMLDivElement, Scrollable.BarProps>(
  S.Scrollbar,
  (props, ref) => (
...
export namespace Scrollable {
  ...
  export type BarProps = Omit<
    React.ComponentPropsWithRef<typeof S.Scrollbar>,
