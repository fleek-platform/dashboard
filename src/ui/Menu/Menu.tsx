...
const Item = forwardStyledRef<HTMLDivElement, Menu.ItemProps>(
  S.Item,
...
export namespace Menu {
  ...
  export type PortalProps = React.ComponentPropsWithRef<
  ...
  export type CheckboxItemProps = React.ComponentPropsWithRef<
    typeof S.CheckboxItem
  >;
  export type ItemIndicatorProps = React.ComponentPropsWithRef<
    typeof S.ItemIndicator
  >;
