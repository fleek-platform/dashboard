...
const Content = forwardStyledRef<HTMLDivElement, Tooltip.Content>(
  S.Content,
  ({ children, ...props }, _ref) => (
    <S.Content {...props}>
      {children}
...
export namespace Tooltip {
  export type Provider = React.ComponentPropsWithRef<
    typeof TooltipRadix.Provider
  >;
  export type Root = React.ComponentPropsWithRef<typeof TooltipRadix.Root>;
  export type Trigger = React.ComponentPropsWithRef<
    typeof TooltipRadix.Trigger
  >;
  export type Portal = React.ComponentPropsWithRef<typeof TooltipRadix.Portal>;
  export type Content = ChildrenProps<
