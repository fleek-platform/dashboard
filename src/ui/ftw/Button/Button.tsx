...
export const buttonIntent = {
  neutral: 'text-neutral-11 bg-neutral-3 enabled:hover:bg-neutral-4 active:bg-neutral-5 focus-visible:ring-neutral-8',
  accent: 'text-accent-11 bg-accent-3 enabled:hover:bg-accent-4 active:bg-accent-5 focus-visible:ring-accent-8',
  success: 'text-success-11 bg-success-3 enabled:hover:bg-success-4 active:bg-success-5 focus-visible:ring-success-8',
  warning: 'text-warning-11 bg-warning-3 enabled:hover:bg-warning-4 active:bg-warning-5 focus-visible:ring-warning-8',
  danger: 'text-danger-11 bg-danger-3 enabled:hover:bg-danger-4 active:bg-danger-5 focus-visible:ring-danger-8',
  ghost:
