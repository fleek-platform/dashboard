  ...
  'flex relative items-center w-fit justify-center focus-visible:ring-2 select-none font-medium transition-all disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        outline:
          'outline outline-1 disabled:outline-neutral-7 disabled:text-neutral-8 disabled:hover:bg-transparent',
      },
      intent: buttonIntent,
      size: {
        xs: 'px-2.5 h-6',
    ...
    compoundVariants: [
      {
        ...
        intent: 'accent',
        className:
          'bg-transparent outline-accent-8 hover:bg-accent-2 active:bg-accent-3',
      },
      {
        variant: 'outline',
        intent: 'success',
        className:
          'bg-transparent outline-success-8 hover:bg-success-2 active:bg-success-3',
      },
      {
        variant: 'outline',
        intent: 'warning',
        className:
          'bg-transparent outline-warning-8 hover:bg-warning-2 active:bg-warning-3',
      },
      {
        variant: 'outline',
        intent: 'danger',
        className:
          'bg-transparent outline-danger-8 hover:bg-danger-2 active:bg-danger-3',
      },
      {
        variant: 'outline',
        intent: 'neutral',
        className:
          'bg-transparent outline-neutral-8 hover:bg-neutral-2 active:bg-neutral-3',
      },
      {
        variant: 'outline',
        intent: 'ghost',
