...
const Root = forwardStyledRef<HTMLDivElement, RadioGroup.RootProps>(S.Root, ({ children, orientation = 'horizontal', ...props }, ref) => {
  return (
...
const Item = forwardStyledRef<HTMLButtonElement, RadioGroup.Item>(S.Item, ({ ...props }, ref) => {
  return (
