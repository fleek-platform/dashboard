...
export type GenerateUserSessionDetailsDataInput = {
...
export type GitApiInsatallation = {
  ...
  gitIntegrationId: Scalars['String'];
...
export type Mutation = {
   ...
   * @deprecated Use siteDeploymentRequirements instead
   */
  ...
  /** @deprecated Do not use this mutation. Every GH integration should be created by GH webhook. */
...
export type Query = {
  ...
  /** Check if repo name is available for creating a new repo */
  ...
  /** @deprecated Use gitApiInstallations instead */
