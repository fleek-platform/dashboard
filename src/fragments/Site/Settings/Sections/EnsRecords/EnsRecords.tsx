...
export type EnsRecordsProps = Pick<SettingsItemProviderProps, 'onSubmitVerification' | 'onSubmitDelete'>;

export const EnsRecords: React.FC<EnsRecordsProps> = ({ onSubmitVerification, onSubmitDelete }) => {
  ...
  return (
    <EnsSettingsProvider onSubmitVerification={onSubmitVerification} onSubmitDelete={onSubmitDelete}>
