...
export const DeletePrimaryDomainModal: React.FC = () => {
  ...
  return (
    <DeleteModal
      title="Remove Domain from Gateway"
      comboboxLabel="New Primary Gateway Domain"
    >
      <Text>
        Are you sure you want to remove the primary gateway domain{' '}
      ...
      <Text>
        Please select another domain to use as your primary gateway domain:
      </Text>
    </DeleteModal>
  );
};
