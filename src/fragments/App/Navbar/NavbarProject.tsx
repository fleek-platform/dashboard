    ...
    <Navbar.Container layout="project" mobile={!enableNavigation}>
      ...
      {enableNavigation && (
        <S.Navigation.Container>
          ...
          <S.Navigation.Link href={constants.EXTERNAL_LINK.FLEEK_DOCS} target={constants.EXTERNAL_LINK.FLEEK_DOCS}>
            Docs
          </S.Navigation.Link>
          <S.Navigation.Link href={constants.EXTERNAL_LINK.FLEEK_SUPPORT} target={constants.EXTERNAL_LINK.FLEEK_SUPPORT}>
            Help
          </S.Navigation.Link>
