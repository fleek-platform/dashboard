  ...
  return (
    <>
      <S.PaymentStatus.Wrapper>
        ...
        <S.Text>Payment has been received successfully, your plan has now been upgraded.</S.Text>
      </S.PaymentStatus.Wrapper>

      <S.PaymentStatus.FinishButton href={routes.home()}>Go to Home</S.PaymentStatus.FinishButton>
    </>
  );
};
