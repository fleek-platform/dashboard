...
export const Step1: React.FC = () => {
  ...
  return (
    <S.Content.Container>
      ...
      <Text>
        We want to take a moment and say we appreciate you for being a Fleek
        user, we look forward to better serving you in the all new Fleek app.
      </Text>
      <LearnMoreMessage prefix="Need Migration Help?" href="#">
        Follow instructions Here
      </LearnMoreMessage>
      <Button
        onClick={handleBeginMigration}
        disabled={isDisabled}
        loading={isSubmittingMigration}
      >
        Begin Migration
      </Button>
    </S.Content.Container>
