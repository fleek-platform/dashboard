    ...
    modalContent: (
      <>
        <ComingSoon.Modal.Description>
          Minting your frontend app hosted on Fleek as a Non-Fungible application is an experimental feature to further the decentralization
          of your site. Users of your app will be able to mint a print of the app and access it privately, while retaining updates you make
          to the frontend.
        </ComingSoon.Modal.Description>
        <ComingSoon.Modal.LearnMore href={'#'}>Non-Fungible Applications</ComingSoon.Modal.LearnMore>
      </>
    ),
  },
};
